...
Current version in this guide: `v0.4.0`
...
```bash
cd /opt
git clone --branch v0.4.0 --depth 1 https://github.com/Kobii-git/Rackpad.git
cd Rackpad
```
...
When a newer release exists, replace `v0.4.0` with the newer version tag.
...
```bash
cd /opt
git clone --branch v0.4.0 --depth 1 https://github.com/Kobii-git/Rackpad.git rackpad
cd /opt/rackpad
```
